...
export function PlanningOverviewV2({ className = 'Sua turma', plans, loading = false, error = '', offline = false, onBack = () => undefined, onRetry = () => undefined, onOpenPlan = () => undefined, onRestorePlan = () => undefined, onCreatePlan = () => undefined, onCreateActivity = () => undefined, onViewChange = () => undefined, onTabChange = () => undefined }: Props) {
