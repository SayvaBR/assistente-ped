...
export function PlanningDayV2({ className = 'Sua turma', dateKey, plans, loading = false, error = '', offline = false, onBack = () => undefined, onRetry = () => undefined, onDateChange = () => undefined, onOpenPlan = () => undefined, onCreatePlan = () => undefined, onTabChange = () => undefined, activeTab = 'planejamento' }: PlanningDayV2Props) {
  ...
  return <main className="v2-root v2-planning-day" aria-labelledby="planning-day-v2-title"><div className="v2-screen v2-planning-day__screen">
    ...
    <div className="v2-planning-day__tabs" role="tablist" aria-label="Visão do planejamento"><button className="is-selected" role="tab" aria-selected="true" type="button">Dia</button><button role="tab" aria-selected="false" type="button" onClick={() => setTimeout(() => onTabChange('planejamento'), 0)}>Semana</button><button role="tab" aria-selected="false" type="button" onClick={() => setTimeout(() => onTabChange('planejamento'), 0)}>Mês</button></div>
