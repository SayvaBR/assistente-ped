...
export function PlanningDayV2({ className = 'Sua turma', dateKey, plans, loading = false, error = '', offline = false, onBack = () => undefined, onRetry = () => undefined, onDateChange = () => undefined, onViewChange = () => undefined, onOpenPlan = () => undefined, onCreatePlan = () => undefined, onTabChange = () => undefined, activeTab = 'planejamento' }: PlanningDayV2Props) {
