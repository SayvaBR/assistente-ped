...
await page.goto(`${baseUrl}/?v2-preview=planning-overview&width=412`, { waitUntil: 'networkidle' });
...
await page.screenshot({ path: 'docs/qa/clean-room/planning-overview-v2-412.png', clip: box });
await browser.close();
console.log('Saved docs/qa/clean-room/planning-overview-v2-412.png');
