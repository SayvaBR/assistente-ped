...
await page.goto(`${baseUrl}/?v2-preview=classes&width=412`, { waitUntil: 'networkidle' });
...
await page.screenshot({ path: 'docs/qa/clean-room/classes-v2-412.png', clip: box });
await browser.close();
console.log('Saved docs/qa/clean-room/classes-v2-412.png');
