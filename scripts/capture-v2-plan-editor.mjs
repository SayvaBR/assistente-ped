...
await page.goto(`${baseUrl}/?v2-preview=plan-editor`, { waitUntil: 'networkidle' });
...
await page.screenshot({ path: 'docs/qa/clean-room/plan-editor-v2-412.png', clip: box });
await browser.close();
console.log('Saved docs/qa/clean-room/plan-editor-v2-412.png');
